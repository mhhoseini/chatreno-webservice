 ...
 */
class Reportreferral extends REST_Controller {
      ...
      if ($command=="get_request")
        {//register marketer
            ...
            if($employeetoken[0]=='ok')
            {
                ...
                $query1="select * from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,fieldcompany_tb where  fieldcompany_company_id=company_id AND fieldcompany_fieldinsurance_id=fieldinsurance_id AND user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND company_id=request_company_id ";
                $query1.=" AND (request_last_state_id=10 OR request_last_state_id=11)";

                $query2="select count(*) AS cnt from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,fieldcompany_tb where fieldcompany_company_id=company_id AND fieldcompany_fieldinsurance_id=fieldinsurance_id AND user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND company_id=request_company_id ";
...
{//register marketer
    ...
    if($employeetoken[0]=='ok')
    {
        ...
        $query1="select * from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,fieldcompany_tb where fieldcompany_fieldinsurance_id=fieldinsurance_id AND user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND company_id=request_company_id ";
        $query1.=" AND (request_last_state_id=10 OR request_last_state_id=11)";

        $query2="select count(*) AS cnt from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,fieldcompany_tb where fieldcompany_fieldinsurance_id=fieldinsurance_id AND user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND company_id=request_company_id ";
        $query2.=" AND (request_last_state_id=10 OR request_last_state_id=11)";
     ...
     //   ,"data"=>$output
        ...
        ,'desc'=>$employeetoken[2]));
          ...
          if($employeetoken[0]=='ok')
          {
              ...
              $query="SELECT marketer_leader_mobile FROM user_tb,usermarketer_tb WHERE marketer_user_id=user_id AND user_mobile='$reagent_mobile'";
