 ...
 */
class Getrequestagent extends REST_Controller {
    ...
    public function index_post()
    {
        ...
        if($this->B_user->checkrequestip('getrequestagent',$command,get_client_ip(),50,50)){
            ...
            if($agenttoken[0]=='ok')
                {
                    ...
                    if(!empty($result0[0])){
                        ...
                        if($agent_id == $result0[0]['request_agent_id']){
                            $covarage =array();
