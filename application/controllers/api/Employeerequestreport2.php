 ...
 */
class Employeerequestreport2 extends REST_Controller {
    ...
    public function index_post()
    {
        ...
        if ($this->B_user->checkrequestip('employeerequestreport', $command, get_client_ip(),50,50)) {
            if ($command=="get_request")
            {//register marketer
                $employeetoken=checkpermissionemployeetoken($employee_token_str,'view','request');
                $request_mode = $this->post("request_mode");
                if($employeetoken[0]=='ok')
                {
                    //************** */
                    $query1 ="";
                    $query2 ="";
                    if(empty($_REQUEST['start_requst_ready_start_date'])&&empty($_REQUEST['requst_ready_code_insurer'])) {
                        $query1 = "select * from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,agent_tb,user_address_tb where user_address_id=request_adderss_id AND user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND  company_id=request_company_id And request_tb.request_agent_id = agent_tb.agent_id ";
                        $query2 = "select count(*) AS cnt from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,agent_tb,user_address_tb where user_address_id=request_adderss_id AND user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND  company_id=request_company_id And request_tb.request_agent_id = agent_tb.agent_id  ";
                    }else{
                        $query1 = "select * from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,agent_tb,requst_ready_tb,user_address_tb where user_address_id=request_adderss_id AND request_id=requst_ready_request_id AND user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND  company_id=request_company_id And request_tb.request_agent_id = agent_tb.agent_id ";
                        $query2 = "select count(*) AS cnt from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,agent_tb,requst_ready_tb,user_address_tb where user_address_id=request_adderss_id AND request_id=requst_ready_request_id AND user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND  company_id=request_company_id And request_tb.request_agent_id = agent_tb.agent_id  ";
                    }
                    //      $query1="select * from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,requst_ready_tb,organ_contract_tb,organ_request_tb where user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND  company_id=request_company_id and request_id=requst_ready_request_id AND request_id=organ_request_request_id And organ_request_contract_id=organ_contract_id ";
                    //     $query2="select count(*) AS cnt from request_tb,company_tb,request_state,fieldinsurance_tb,user_tb,requst_ready_tb,organ_contract_tb,organ_request_tb where user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND  company_id=request_company_id and request_id=requst_ready_request_id  AND request_id=organ_request_request_id And organ_request_contract_id=organ_contract_id ";
                    $query="";

                    if($request_mode=='notpay'){
                        $query.=" AND request_last_state_id<2 ";
                    }else{
                        $query.=" AND request_last_state_id<>0 AND request_last_state_id<>1 AND request_last_state_id<>13 AND request_last_state_id<>14 AND request_last_state_id<>15";
                    }
                    ...
                    if(!empty($_REQUEST['request_last_state_id'])){
                        ...
                        $query.=" AND request_last_state_id  IN (".$request_last_state_id.")";
                    }
...
if(!empty($_REQUEST['requst_ready_code_insurer'])){
                    ...
                    $ssssssssss=$query1.$query.$limit_state;
                    $output =array();
                    $request_id='';
                    foreach($result as $row)
                    {
                        ...
                        if($row['request_organ']=='1'){
                            ...
                            if(!empty($result200)) {
                                ...
                                //            $image = $result1[0];
                                //            if ($image['image_url']) {
                                //                $imageurl = IMGADD . $image['image_url'];
                                //            }
                                //        }
                        ...
                        if($row['request_agent_id']!=null || $row['request_agent_id']!=""){
                            ...
                            //****************************************************************************
//                        $query112=" SELECT * FROM image_tb WHERE image_code='".$agent['agent_image_code']."'";
...
//                            $image=array();
                            //*******************************************************************
//                        $record['agent_image']=IMGADD.$image['image_url'];
//                        $record['agent_image_tumb']=IMGADD.$image['image_tumb_url'];
...
//                    }
                        ...
                        foreach($result6 as $row6)
                        {
                            ...
                            $record6['requst_ready_timestamp']=$row6['requst_ready_timestamp'];
                            ...
                            $record['requst_ready_employee_id']=$row6['requst_ready_employee_id'];
                            //*************************************************************************************************************
...
//                        $query51=" SELECT * FROM image_tb WHERE image_code='".$row5['request_delivered_receipt_image_code']."'";
//                        $result51=$this->B_db->run_query($query51);
//                        if(!empty($result51))
//                            $image=$result51[0];
//                        else
//                            $image=array();
//                        if($image['image_tumb_url']==null){ $record5['user_pey_image_turl']=null;}else{ $record5['user_pey_image_turl']=IMGADD.$image['image_tumb_url'];}
//                        if($image['image_url']==null){ $record5['user_pey_image_url']=null;}else{$record5['user_pey_image_url']=IMGADD.$image['image_url'];}
//                        $output5[]=$record5;
//                    }
...
//                    $record['visit_image']=$output44;
                    ...
                    ,"data"=>$output
                    ,"cnt"=>$count[0]['cnt']
                    ,'desc'=>'لیست درخواست ها با موفقیت ارسال شد'.$ssssssssss),JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
                }else{
                ...
                if ($command=="get_request_nodetail")
                {//register marketer
                    $employeetoken=checkpermissionemployeetoken($employee_token_str,'view','request');
                    if($employeetoken[0]=='ok')
                    {
...
//                    $record['visit_image']=$output44;
                    ...
                    if ($command=="get_requestoffline") {//register marketer
                        $employeetoken = checkpermissionemployeetoken($employee_token_str, 'view', 'requestoffline');
                        if ($employeetoken[0] == 'ok') {
                            $query = "select * from request_tb,request_state,fieldinsurance_tb,user_tb where user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND  request_last_state_id=13";
                        ...
                        if ($command=="get_cancel_requestoffline") {//register marketer
                            $employeetoken = checkpermissionemployeetoken($employee_token_str, 'view', 'requestoffline');
                            if ($employeetoken[0] == 'ok') {
                                $query = "select * from request_tb,request_state,fieldinsurance_tb,user_tb where user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND  request_last_state_id=15";
                            ...
                            if ($command=="get_requestofflinepriced") {//register marketer
                                $employeetoken = checkpermissionemployeetoken($employee_token_str, 'view', 'requestoffline');
                                if ($employeetoken[0] == 'ok') {
                                    $query = "select * from request_tb,request_state,fieldinsurance_tb,user_tb where user_id=request_user_id AND fieldinsurance=request_fieldinsurance AND request_state_id=request_last_state_id AND  request_last_state_id=14";
                                ...
                                if ($command=="add_requestoffline") {//register marketer
                                    $employeetoken = checkpermissionemployeetoken($employee_token_str, 'modify', 'requestoffline');
                                    if ($employeetoken[0] == 'ok') {
                                        $request_id = $this->post("request_id");
                                        ...
                                        $query1 = "INSERT INTO jsonpricing_tb
         ( jsonpricing_text        , jsonpricing_date   ,  jsonpricing_fieldinsurance, jsonpricing_request_id, jsonpricing_employee_id)
VALUES ( '" . $jsonpricing_text1 . "'  ,   now()         ,'$fieldinsurance', $request_id, $employeetoken[1]) ";
                                    ...
                                    if ($command=="get_priceoffline") {//register marketer
                                        $employeetoken = checkpermissionemployeetoken($employee_token_str, 'modify', 'requestoffline');
                                        if ($employeetoken[0] == 'ok') {
                                            $request_id = $this->post("request_id");
                                            $query = "select * from jsonpricing_tb where jsonpricing_request_id=$request_id";
                                        ...
                                        if ($command=="delete_priceoffline") {//register marketer
                                            $employeetoken = checkpermissionemployeetoken($employee_token_str, 'modify', 'requestoffline');
                                            if ($employeetoken[0] == 'ok') {
                                                $jsonpricing_id = $this->post("jsonpricing_id");
                                                $query = "DELETE FROM  jsonpricing_tb where jsonpricing_id=$jsonpricing_id";
                                            ...
                                            if ($command=="modify_priceoffline") {//register marketer
                                                $employeetoken = checkpermissionemployeetoken($employee_token_str, 'modify', 'requestoffline');
                                                if ($employeetoken[0] == 'ok') {
                                                    $jsonpricing_id = $this->post("jsonpricing_id");
                                                    $jsonpricing_text = $this->post("jsonpricing_text");
                                                    ...
                                                    $query = "UPDATE jsonpricing_tb
SET jsonpricing_text='$jsonpricing_text1', jsonpricing_date=now(), jsonpricing_employee_id=$employeetoken[1] 
WHERE jsonpricing_id=$jsonpricing_id";
                                                    $result2=$this->B_db->run_query_put($query);
                                            ...
                                            else if ($command=="requestpricedoffline14") {//register marketer
                                                $employeetoken = checkpermissionemployeetoken($employee_token_str, 'modify', 'requestoffline');
                                                if ($employeetoken[0] == 'ok') {
                                                    $request_id=$this->post('request_id') ;

                                                    $query1="UPDATE request_tb SET request_last_state_id=14  WHERE request_id=$request_id";
                                                    $result1 = $this->B_db->run_query_put($query1);

                                                    $desc='قیمت دهی توسط اپراتور' ;
                                                    $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_employee_id) VALUES
                                        ( $request_id, 14, now(),'$desc',$employeetoken[1])";
                                                ...
                                                if ($command=="requestpricedoffline15") {//register marketer
                                                    $employeetoken = checkpermissionemployeetoken($employee_token_str, 'modify', 'requestoffline');
                                                    if ($employeetoken[0] == 'ok') {
                                                        $request_id=$this->post('request_id') ;

                                                        $query1="UPDATE request_tb SET request_last_state_id=15  WHERE request_id=$request_id";
                                                        $result1 = $this->B_db->run_query_put($query1);

                                                        $desc=' انصراف از قیمت دهی توسط اپراتور ' ;
                                                        $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_employee_id) VALUES
                                        ( $request_id, 15, now(),'$desc',$employeetoken[1])";
                                                        $result = $this->B_db->run_query_put($query);
                                                    ...
                                                    if ($command=="requestpending3")
                                                    {//register marketer
                                                        $agent_id=$this->post('agent_id') ;
                                                        $employeetoken=checkpermissionemployeetoken($employee_token_str,'modify','request');
                                                        if($employeetoken[0]=='ok')
                                                        {
                                                            //***************************************************************************************************************
                                                            $agent_id=$this->post('agent_id') ;
                                        ...
                                        ( $request_id, 3, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                request_send_sms($request_id,'user',$desc);
                                                                $result = $this->B_db->run_query_put($query);
                                                                echo json_encode(array('result'=>"ok"
                                                        ...
                                                        {//register marketer
                                                            ...
                                                            {//register marketer
                                                                ...
                                                                if($employeetoken[0]=='ok')
                                                                {
                                                                    ...
                                                                    if($request['request_last_state_id']==3||$request['request_last_state_id']==7||$request['request_last_state_id']==8){
                                                                        //***************************************************************************************************************
                                                                        ...
                                                                        $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                        ( $request_id, 4, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                        $descipt=request_send_sms($request_id,'user',$desc);
                                                                        $result = $this->B_db->run_query_put($query);
...
WHERE user_wallet_code=$request_id AND user_wallet_mode='get' ";
		                                   ...
		                                   (  $user_id       ,'".$row['user_pey_amount']."','add',   now()                    ,'$desc' ,'" .$row['user_pey_code']."' )";
                                                                ...
                                                                if ($command=="requestbackagent5")
                                                                {//register marketer
                                                                    $employeetoken=checkpermissionemployeetoken($employee_token_str,'modify','request');
                                                                    if($employeetoken[0]=='ok')
                                                                    {
                                                                        $agent_id=$employeetoken[1];
                                                                        //***************************************************************************************************************
                                                                        $request_id=$this->post('request_id') ;
                                                                        $agent_id=$this->post('agent_id') ;
                                                                        $company_id=$this->post('company_id') ;
                                                                        $newagent_id=$this->post('newagent_id') ;
                                                                        ...
                                                                        if($request['request_last_state_id']!=5){
                                                                            //***************************************************************************************************************
                                                                            $query1="UPDATE request_tb SET request_last_state_id=2 ,request_agent_id=$newagent_id,request_company_id=$company_id WHERE request_id=$request_id";
                                                                            $result1 = $this->B_db->run_query_put($query1);

                                                                            $desc=' درخواست به نماینده دیگر ارجاع داده شد به علت'.$request_backagent_desc.' آی دی نماینده جدید ' .$newagent_id;
                                                                            $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                        ( $request_id, 5, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                            $result = $this->B_db->run_query_put($query);
                                        ...
                                        ( $request_id, now(),'$request_backagent_desc',$agent_id)";
                                                                    ...
                                                                    if ($command=="requestdepositdeficit6")
                                                                    {//register marketer
                                                                        $employeetoken=checkpermissionemployeetoken($employee_token_str,'modify','request');
                                                                        if($employeetoken[0]=='ok')
                                                                        {
                                                                            ...
                                                                            if($request['request_last_state_id']!=6){
                                                                                ...
                                                                                $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                        ( $request_id, 6, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                                $result = $this->B_db->run_query_put($query);
                                        ...
                                        ( $request_id, $deficit_pey_amount,'$deficit_pey_reason')";
                                                                        ...
                                                                        if ($command=="requestoverpayment12")
                                                                        {//register marketer
                                                                            $employeetoken=checkpermissionemployeetoken($employee_token_str,'modify','request');
                                                                            if($employeetoken[0]=='ok')
                                                                            {
                                  ...
                                  ($user_id             , $overpayment_amount   ,    'add'      ,now()               ,'$user_wallet_detail',$request_id)      ";
                                      ...
                                      (  $request_id           , $overpayment_amount, 'overpayment'    ,  $user_wallet_id   ,'$user_pey_temp_desc',now())      ";
                                                                                $user_pey_id=$this->B_db->run_query_put($query1);
                                                                            ...
                                                                            if ($command=="requestdeletedepositdeficit6")
                                                                            {//register marketer
                                                                                ...
                                                                                {//register marketer
                                                                                    ...
                                                                                    if($employeetoken[0]=='ok')
                                                                                    {
                                                                                        ...
                                                                                        if($request['request_last_state_id']!=7){
                                                                                            ...
                                                                                            $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                        ( $request_id, 7, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                                            $result = $this->B_db->run_query_put($query);
                                                                                            request_send_sms($request_id,'user',$desc);
                                                                                    ...
                                                                                    {//register marketer
                                                                                        ...
                                                                                        if($employeetoken[0]=='ok')
                                                                                        {
                                                                                            ...
                                                                                            if($request['request_last_state_id']!=8){
                                                                                                ...
                                                                                                $desc=' معلق است برای صدور به علت '.$request_difficult_desc;
                                                                                                $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                        ( $request_id, 8, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                                                $result = $this->B_db->run_query_put($query);
                                                                                        ...
                                                                                        {//register marketer
                                                                                            ...
                                                                                            if($employeetoken[0]=='ok')
                                                                                            {
                                                                                                ...
                                                                                                if($request['request_last_state_id']!=9){
                                                                                                    ...
                                                                                                    $desc=' در حال صدور ';
                                                                                                    $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                        ( $request_id, 9, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                                                    $result = $this->B_db->run_query_put($query);
                                                                                            ...
                                                                                            {//register marketer
                                                                                                ...
                                                                                                if($employeetoken[0]=='ok')
                                                                                                {
                                                                                                    ...
                                                                                                    if($request['request_last_state_id']!=10){
                                                                                                        ...
                                                                                                        $query="INSERT INTO requst_ready_tb( requst_ready_request_id, requst_ready_timestamp, requst_ready_start_date, requst_ready_end_date, requst_ready_end_price, requst_ready_num_ins,requst_ready_code_rayane,requst_ready_code_penalty, requst_ready_code_yekta, requst_ready_name_insurer, requst_ready_code_insurer, requst_suspend_desc, requst_suspend_agent_id,requst_ready_employee_id,request_ready_clearing_id) VALUES
                                        ( $request_id, now()                       ,'$requst_ready_start_date' ,'$requst_ready_end_date' ,'$requst_ready_end_price' ,'$requst_ready_num_ins','$requst_ready_code_rayane','$requst_ready_code_penalty','$requst_ready_code_yekta','$requst_ready_name_insurer','$requst_ready_code_insurer' ,'$requst_suspend_desc',$agent_id,$employeetoken[1],$request_ready_clearing_id)";
                                                                                                        $requst_ready_id = $this->B_db->run_query_put($query);
                                                                                                        if($requst_ready_id) {
                                                                                                            ...
                                                                                                            $query = "INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                        ( $request_id, 10, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                                                            $result = $this->B_db->run_query_put($query);
...
//**********************************************************************************
                                                                                                            ...
                                                                                                            $result2 = $this->B_db->run_query($query2);
                                                                                                            $user_pey2 = $result2[0];
                                                                                                            $user_pey_cash = ($user_pey2['sumcash'] - $overpayment) * 100 / 109;
                                                                                                ...
                                                                                                {//register marketer
                                                                                                    ...
                                                                                                    if($employeetoken[0]=='ok')
                                                                                                    {
                                                                                                        ...
                                                                                                        $query2="select * from requst_ready_tb where requst_ready_request_id=".$request_id."";
                                                                                                        $result=$this->B_db->run_query($query2);
                                                                                                        $request_ready=$result[0];
                                                                                                        if($request['request_last_state_id']>=10){
                                                                                                            //***************************************************************************************************************


                                                                                                            $query="UPDATE requst_ready_tb SET  requst_ready_timestamp=now()  , requst_ready_start_date='$requst_ready_start_date', requst_ready_end_date='$requst_ready_end_date'
                                                                             , requst_ready_end_price='$requst_ready_end_price', requst_ready_num_ins='$requst_ready_num_ins',requst_ready_code_rayane='$requst_ready_code_rayane' 
                                                                              ,requst_ready_code_penalty='$requst_ready_code_penalty', requst_ready_code_yekta='$requst_ready_code_yekta', requst_ready_name_insurer='$requst_ready_name_insurer' 
                                                                              , requst_ready_code_insurer='$requst_ready_code_insurer', requst_suspend_desc='$requst_suspend_desc', requst_suspend_agent_id=$agent_id,requst_ready_employee_id=$requst_ready_employee_id
                                                             ,request_ready_clearing_id=$request_ready_clearing_id WHERE requst_ready_request_id=$request_id";
...
//**********************************************************************************
                                                                                                            ...
                                                                                                            if($request_ready['requst_ready_end_price']=!$requst_ready_end_price || $request_ready['requst_ready_end_price']=!$requst_ready_end_price) {
                                                                                                                $query0 = "select sum(user_pey_amount) AS overpayment from user_pey_tb where user_pey_mode='overpayment' AND user_pey_request_id=" . $request_id;
                                                                                                                $result0 = $this->B_db->run_query($query0);
                                                                                                                if (!empty($result0))
                                                                                                                    $user_pey0 = $result0[0];
                                                                                                            ...
                                                                                                            echo json_encode(array('result' => "ok"
                                                                                                            , "data" => get_request($request_id)
                                                                                                            , 'desc' => ' تغییر مرحله درخواست ثبت شد'.$query), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
...
//***************************************************************************************************************
                                                                                                                ...
                                                                                                                $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                                                ( $request_id, 13, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                                                                $result = $this->B_db->run_query_put($query);
                                                                                                        ...
                                                                                                        {//register marketer
                                                                                                            ...
                                                                                                            if($employeetoken[0]=='ok')
                                                                                                            {
                                                                                                                ...
                                                                                                                if($request['request_last_state_id']==3){
                                                                                                                    ...
                                                                                                                    $desc='نیار به بازدید';
                                                                                                                    $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                        ( $request_id, 16, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                                                                    $result = $this->B_db->run_query_put($query);
                                                                                                                    request_send_sms($request_id,'user',$desc);
                                        ...
                                        ( $request_id, 3, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                                                                ...
                                                                                                                if ($command=="requestreadyimgsave")
                                                                                                                {//register marketer
                                        ...
                                        ( $request_id,'$requst_ready_image_code')";
                                                                                                                            ...
                                                                                                                            echo json_encode(array('result'=>"error"
                                                                                                                            ,"data"=>""
                                                                                                                            ,'desc'=>' عکسها به درخواست صادر شده اضافه نشد'),JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
                                                                                                                        }
                                                                                                                    ...
                                                                                                                    {//register marketer
                                                                                                                        ...
                                                                                                                        if($employeetoken[0]=='ok')
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            if($request['request_last_state_id']==10||$request['request_last_state_id']==11){
                                                                                                                                ...
                                                                                                                                $desc=' ارسال به کاربر ';
                                                                                                                                $query="INSERT INTO state_request_tb( staterequest_request_id, staterequest_state_id, staterequest_timestamp,staterequest_desc,staterequest_agent_id,staterequest_employee_id) VALUES
                                        ( $request_id, 11, now(),'$desc',$agent_id,$employeetoken[1])";
                                                                                                                                $result = $this->B_db->run_query_put($query);
...
VALUES( 83                            , 1                              ,$instalment_check_user_pey_id,'$instalment_check_date','$instalment_check_num','$instalment_check_amount','$instalment_check_desc',  $request_id               ,''                         ," . $employeetoken[1] . "          );
";
                                                                                                                                                $result = $this->B_db->run_query_put($query);
...
VALUES($request_id, $instalment_check_amount, 'instalment', 84            , 'پرداخت  توسط کسر از حقوق',  now()    ,'');";
                                                                                                                                                ...
                                                                                                                                                $query = "INSERT INTO instalment_check_tb
       ( instalment_check_condition_id, instalment_check_instalment_id, instalment_check_user_pey_id , instalment_check_date, instalment_check_num, instalment_check_amount, instalment_check_desc,  instalment_check_request_id,instalment_check_image_code, instalment_check_employee_id)
VALUES( 84                            , 1                              ,$instalment_check_user_pey_id,'$instalment_check_date','$instalment_check_num','$instalment_check_amount','$instalment_check_desc',  $request_id         ,''                        ," . $employeetoken[1] . "          );
";
                                                                                                                                                $result = $this->B_db->run_query_put($query);
                                                                                                                                            }
...
";
                                                                                                                                    ...
                                                                                                                                    {//register marketer
                                                                                                                                        ...
                                                                                                                                        {//register marketer
                                                                                                                                            ...
                                                                                                                                            if ($command=="get_mode_delivery")
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                echo json_encode(array('result'=>"ok"
                                                                                                                                                ,"data"=>$output
                                                                                                                                                ,'desc'=>'انواع روش ارسال درخواست ارسال شد'),JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
                                                                                ...
                                                                                ( $request_file_request_id ,'$request_file_url' ,'$request_file_desc' )";
                                                                                                                                                                ...
                                                                                                                                                                echo json_encode(array('result'=>"ok"
                                                                                                                                                                ,"data"=>get_request($request_file_request_id)
...
//***************************************************************************************************************
			...
			AND user_id=request_user_id AND fieldinsurance=request_fieldinsurance  AND company_id=request_company_id ";
                                                                                                                                                                ...
                                                                                                                                                                foreach($result as $row)
                                                                                                                                                                {
                                                                                                                                                                    ...
                                                                                                                                                                    if(!empty($result1))
                                                                                                                                                                        ...
                                                                                                                                                                        $image=array();
                                                                                                                                                                    if($image['image_tumb_url']==null){ $record['check_image_turl']=null;}else{ $record['check_image_turl']=$image['image_tumb_url'];}
                                                                                                                                                                    if($image['image_url']==null){ $record['check_image_url']=null;}else{$record['check_image_url']=$image['image_url'];}
...
//***************************************************************************************************************
                                                                                                                                                                    ...
                                                                                                                                                                    if($instalment_check['instalment_check_pass']==0){
                                                                                                                                                                        ...
                                                                                                                                                                        $query1="UPDATE instalment_check_tb SET instalment_check_pass=1,instalment_check_date_pass='$instalment_check_date_pass',instalment_check_employee_id=$employee_id WHERE instalment_check_id=$instalment_check_id";
                                                                                                                                                                        $result1 = $this->B_db->run_query_put($query1);
                                        ...
                                        ( $request_id, now(),'$requestcouncil_desc',$agent_id,$employeetoken[1],'$requestcouncil_image_code')";
                                                                                                                                                                        $result = $this->B_db->run_query_put($query);
    ...
    public function copy_post(){
        ...
        if($employeetoken[0]=='ok')
        {
            $query = " SELECT request_id,request_fieldinsurance FROM request_tb";
            $result = $this->B_db->run_query($query);
            foreach($result as $res){
                if(!empty($res)){
                    $request_id = $res['request_id'];
                    $request_fieldinsurance = $res['request_fieldinsurance'];
                    $query1 = "SELECT fieldinsurance_id FROM fieldinsurance_tb where fieldinsurance='".$request_fieldinsurance."'";
                    $result1 = $this->B_db->run_query($query1);
                    if(!empty($result1)){
                        $q = "update request_tb set request_fieldinsurance_id=".$result1[0]['fieldinsurance_id']." where request_id=".$request_id;
                        $this->B_db->run_query_put($q);
                        echo json_encode(array('result'=>"ok"
                        ,'desc'=>'درخواست اضافه شد'),JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
                    }else{
                        echo json_encode(array('result'=>"error"
